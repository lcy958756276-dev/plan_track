...
if(NOT "/home/lcy/robot_graduation（复件）/src/navigation/map_server/include " STREQUAL " ")
  set(map_server_INCLUDE_DIRS "")
  set(_include_dirs "/home/lcy/robot_graduation（复件）/src/navigation/map_server/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lcy/robot_graduation（复件）/src/navigation/map_server/${idir}'.  ${_report}")
    endif()
